...
class CoderState(BaseModel):
    ...
    generated_files: dict[str, str] = Field(default_factory=dict, description="Map of filepath -> generated code for cross-file context")

class EditRequest(BaseModel):
    """Represents a request to edit an existing file."""
    filepath: str = Field(description="Path of the file to edit")
    existing_content: str = Field(description="Current content of the file")
    instruction: str = Field(description="What to change in the file")